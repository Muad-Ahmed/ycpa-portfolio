        ...
        <section id="about" className="py-24 bg-white dark:bg-corporate-950">
            <div className="section-container">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                    <div>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold mb-8">Professional <br /><span className="text-accent-gold">Qualifications</span></h2>
                        <p className="text-base md:text-lg text-corporate-600 dark:text-corporate-400 mb-8 leading-relaxed font-sans">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8 lg:mt-0">
                        <div className="space-y-4">
                            <div className="h-40 md:h-48 bg-corporate-100 dark:bg-corporate-900 overflow-hidden relative border border-corporate-200 dark:border-corporate-800">
                            ...
                            <div className="h-56 md:h-64 bg-accent-navy flex flex-col justify-end p-6 border border-accent-navy">
                                <span className="text-white/60 text-[10px] uppercase tracking-widest mb-2 font-bold">Latest Milestone</span>
                                <span className="text-white text-lg md:text-xl font-bold">Successfully Audited Yemen Mobile (2013-16)</span>
                            </div>
                        </div>
                        <div className="space-y-4 pt-0 sm:pt-8">
                            <div className="h-56 md:h-64 bg-accent-gold flex flex-col justify-end p-6 border border-accent-gold">
                                <span className="text-white/80 text-[10px] uppercase tracking-widest mb-2 font-bold">Core Standard</span>
                                <span className="text-white text-lg md:text-xl font-bold">Expert in IFRS & ISA Methodologies</span>
                            </div>
                            <div className="h-40 md:h-48 bg-corporate-200 dark:bg-corporate-800 border border-corporate-300 dark:border-corporate-700">
