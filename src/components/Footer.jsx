...
const Footer = () => {
    return (
        <footer className="bg-white dark:bg-corporate-950 border-t border-corporate-200 dark:border-corporate-800 py-20">
            <div className="section-container">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    <div className="lg:col-span-2">
                        <span className="text-2xl font-serif font-bold tracking-tight text-accent-navy dark:text-corporate-100">
                            M. AL-DHUBAIBI <span className="text-accent-gold">YCPA</span>
                        </span>
                        <p className="mt-6 text-corporate-600 dark:text-corporate-400 max-w-sm leading-relaxed">
                        ...
                        <div className="mt-8 flex gap-4">
                            <a href="#" className="p-3 bg-corporate-100 dark:bg-corporate-900 rounded-sm hover:bg-accent-gold hover:text-white transition-all">
                                <Linkedin size={20} />
                            </a>
                            <a href="mailto:mhdhubaibi@gmail.com" className="p-3 bg-corporate-100 dark:bg-corporate-900 rounded-sm hover:bg-accent-gold hover:text-white transition-all">
                                <Mail size={20} />
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-corporate-600 dark:text-corporate-400">
                    ...
                    <div>
                        ...
                        <div className="space-y-4 text-corporate-600 dark:text-corporate-400">
                ...
                <div className="pt-8 border-t border-corporate-100 dark:border-corporate-900 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-corporate-400">
                    <p>© {new Date().getFullYear()} Mohammed Abdullah Al-Dhubaibi. All rights reserved.</p>
                    <p className="flex items-center gap-2 tracking-widest text-[10px] uppercase font-bold">
                        Developed for Executive Excellence <span className="text-accent-gold">|</span> YCPA
                    </p>
                </div>
            </div>
        </footer>
